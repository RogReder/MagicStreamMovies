...
func GenerateAllTokens(email, firstName, lastName, role, userId string) (string, string, error) {
	...
	refreshToken := jwt.NewWithClaims(jwt.SigningMethodHS256, refrshClaims)
...
func ValidationToken(tokenString string) (*SignedDetails, error) {
	claims := &SignedDetails{}
